...
export const schoolSafetyIntakeBaseSchema = z.object({
  consent: z.object({
...
export const schoolSafetyIntakeLiteSchema = schoolSafetyIntakeBaseSchema.pick({
  consent: true,
  schoolContact: true,
  finalConfirmation: true,
});

export const schoolSafetyIntakeSchema =
  schoolSafetyIntakeBaseSchema.superRefine((values, ctx) => {
    if (
...
>;
export type SchoolSafetyIntakeLiteValues = z.output<
  typeof schoolSafetyIntakeLiteSchema
>;

export type SchoolSafetyIntakeLiteInput = z.input<
  typeof schoolSafetyIntakeLiteSchema
>;
