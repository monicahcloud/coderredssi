...
const pillars: Pillar[] = [
  ...
  },
  {
    ...
    category: "Equip",
    title: "Equipment",
    description: "Provide the right tools and support a faster response.",
...
export default function ReassessmentFramework() {
  return (
    <section className="relative w-full max-w-full overflow-hidden bg-[#080808] px-5 py-14 text-white sm:px-8 lg:px-14 lg:py-16 xl:px-20 2xl:px-28">
      {/* Blueprint grid */}
      ...
      <div className="relative w-full max-w-full">
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          ...
          <p className="max-w-xl text-sm leading-7 text-white/60 sm:text-base">
            Equipment is most effective when it supports assessment, education,
            daily procedures, and continuous improvement.
          </p>
        </div>
