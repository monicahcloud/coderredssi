import { BadgeCheck, BarChart3, Globe2, Handshake } from "lucide-react";
  ...
  return (
    <section className="relative overflow-hidden bg-black px-6 py-24 text-white md:px-10 xl:px-16 2xl:px-24">
      ...
      <div className="relative mx-auto w-full max-w-full">
        ...
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-2">
          {benefits.map((benefit) => {
            ...
            return (
              <div
                key={benefit.title}
                className="group border border-white/10 bg-white/[0.04] p-7 transition-all duration-300 hover:-translate-y-1 hover:border-red-600 hover:bg-red-950/20">
                <div className="mb-4 inline-flex items-center gap-5">
                ...
                <p className="text-center justify-center items-center mx-auto flex text-lg leading-4 text-zinc-300">
                  {benefit.description}
                </p>
              </div>
            );
        ...
        <div className="mt-10 rounded-none border border-red-600/30 bg-red-950/30 p-8 sm:p-10">
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-4xl text-base leading-6 text-zinc-300">
            ...
            <div className="rounded-2xl bg-white px-6 py-3 text-center text-slate-950">
