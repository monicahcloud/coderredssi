...
export default function EquipmentCTA() {
  return (
    <section className="relative w-full max-w-full overflow-hidden bg-gradient-to-r from-red-800 via-red-700 to-red-600 px-5 py-14 text-white sm:px-8 lg:px-14 lg:py-16 xl:px-20 2xl:px-28">
      {/* Blueprint grid */}
      ...
      <div className="relative grid w-full max-w-full gap-10 lg:grid-cols-[1.5fr_auto] lg:items-center">
        {/* CTA content */}
        <div>
          ...
          <h2 className="mt-5 text-4xl font-black uppercase leading-[1.02] tracking-tight sm:text-5xl lg:text-6xl">
            Equip your campus
            <span className="block">for a faster response.</span>
          </h2>

          <p className="mt-5 max-w-3xl text-base leading-7 text-white/80 sm:text-lg">
            Let&apos;s build an equipment plan that gives your team the right
            tools, stronger coordination, and greater confidence.
          </p>
